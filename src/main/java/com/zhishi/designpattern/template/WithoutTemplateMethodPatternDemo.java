package com.zhishi.designpattern.template;
...
public class WithoutTemplateMethodPatternDemo {
    ...
    public static void main(String[] args) {
        ...
        /**
         * 有一个问题
         * 就是说，这个三中优惠方式计算器里面，都有一段通用的计算逻辑，是完全相同的代码
         * 但是相同的一段代码，给通过复制粘贴的方式，放到了不同类里面去
         * 一旦说，那段通用的计算逻辑，要修改，就设计多个类都要去修改那个代码
         * 如果你一旦忘了修改某个类的那段代码，后果不堪设想
         * 而且到了后期，几乎没人记得清楚，那段通用逻辑代码放到了多少个类中，如果要排查，需要将很多类重新读一遍代码
         * 这就是垃圾代码，扩展性，维护性，很烂
         */
    }
